...
class ThemeScope extends StatefulWidget {
  ...
  static ThemeGeneratorBase of(BuildContext context) =>
      InheritedModel.inheritFrom<_InheritedThemeScope>(context)
          ?.themeGenerator ??
          (throw ArgumentError(
...
class _InheritedThemeScope
    extends InheritedModel<ThemeGeneratorBase> {

  final ThemeGeneratorBase themeGenerator;
